...
function LoginAdmin() {
  ...
  const demoCredentials = {
    email: 'demoAdmin@nexmigrate.com',
        ...
        <div className="w-full max-w-md flex flex-col items-center relative">
          <div className="relative bg-gray-100 p-8 rounded-2xl w-full flex flex-col items-center" style={{boxShadow: '8px -8px 32px -8px #06b6d4, 0 8px 32px 0 rgba(0,0,0,0.15)'}}>
            <div className="flex items-center gap-2 mb-8">
              <h2 className="text-4xl font-extrabold text-center text-black transition-all duration-300 hover:[text-shadow:0_0_12px_#06b6d4,0_0_2px_#06b6d4] cursor-pointer">Admin Login</h2>
                  ...
                  <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 p-4 z-50" ref={popoverRef}>
                    <div className="text-center">
                      ...
                      <p className="text-sm text-gray-600 mb-4">
                        Want to try a demo? Click below to log in with dummy credentials and explore the admin dashboard with mock data.
                      </p>
                      <button
